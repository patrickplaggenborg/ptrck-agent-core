---
name: atlassian
description: Python utilities for Jira and Confluence integration. Provides issue management, search, workflows, page management, and more. This skill should be used when users need to interact with Atlassian products like "create a Jira issue", "search Confluence pages", or "update sprint status".
---

# Atlassian Skills

Python utilities for Jira and Confluence integration, supporting both Cloud and Data Center deployments.
...
# Confluence skills will fail with ConfigurationError
