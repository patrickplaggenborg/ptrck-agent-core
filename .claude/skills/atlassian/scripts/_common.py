...
This module provides shared functionality used by Jira and Confluence scripts:
...
class AtlassianCredentials:
    """Unified credentials configuration for Atlassian services.

    This class wraps authentication credentials for Jira and Confluence.
    ...
    def get_unavailable_services(self) -> Dict[str, str]:
        ...
        Returns:
            ...
            Example: {"confluence": "Missing confluence_url"}
        """
        unavailable = {}
...
class AtlassianConfig:
    ...
    def from_credentials(cls, credentials: AtlassianCredentials, service: str) -> "AtlassianConfig":
        ...
        if service == "jira":
            ...
            raise ConfigurationError(f"Unknown service: {service}. Must be 'jira' or 'confluence'.")
...
def check_available_skills(credentials: AtlassianCredentials) -> Dict[str, Any]:
    ...
    Example:
        ...
        ["jira"]
        >>> print(result["unavailable_services"])
